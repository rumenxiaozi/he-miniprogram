...
Page({
  ...
  onLoad: function () {
    ...
    that.setData({
      ...
      prodList : [
        { "id": "p0", prodName: "中国银行", logo: '../../images/logos/zgyh_logo.jpg', 
        desc: '中国银行 (BANK OF CHINA, 简称BOC，中行) 经孙中山...', compCode: 'YH' },
        { "id": "p1", prodName: "平安银行", logo: '../../images/logos/payh_logo.jpg', compCode: 'YH' },
        { "id": "p2", prodName: "建设银行", logo: '../../images/logos/jsyh_logo.jpg', compCode: 'YH' },
        { "id": "p3", prodName: "成都银行", logo: '../../images/logos/cdyh_logo.jpg', compCode: 'YH' },
        { "id": "p4", prodName: "农业银行", logo: '../../images/logos/nyyh_logo.jpg', compCode: 'YH' },
